export default {
  ...
  messages: {
    ...
    "app.home.product-mobile-slogan":
      "基于 Preact / React / React Native 的 UI 组件库",
    "app.home.product-hitu": "海兔",
    "app.home.product-hitu-slogan": "全新一代图形化解决方案",
    "app.home.product-kitchen-slogan":
      "一款为设计者提升工作效率的 Sketch 工具集",
    ...
    "app.docs.components.icon.pic-searcher.modelloading":
      "神经网络模型加载中...",
